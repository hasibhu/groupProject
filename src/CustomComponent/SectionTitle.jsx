...
export default function SectionTitle({
  ...
  return (
    <div className=" max-w-[1440px] mx-auto flex flex-col items-center justify-center">
      ...
      <h2 className="text-[#444444] text-3xl my:2 lg:my-3 md:text-4xl font-semibold">
        {subTitleArray.slice(0, designAmount).join(" ") + " "}
        <span className="text-[#E43C5C]">
          {subTitleArray.slice(designAmount).join(" ")}
        </span>
      </h2>
      <p className=" p-3 lg:p-0 w-full md:w-1/2 md:text-lg text-sm text-black/70 text-center">
        {description}
      </p>
    </div>
  );

...
const SliderCart = ({ bg, title, subTitle, description }) => {
  return (
    <div className={` lg:h-[700px] w-full relative`}>
      ...
      <div className="space-y-5 flex items-center justify-center bg-opacity-80 text-white absolute top-0 left-0 w-full h-full bg-black">
        <div className="space-y-5">
          ...
          <p className="lg:text-lg text-center lg:w-2/3 mx-auto">{description}</p>
